...
@media (max-width: 768px) {
  ...
  .image-panel {
    flex: none;
    height: 800px; /* Even bigger height for mobile */
    order: 1;
    flex-direction: column;
    gap: 20px;
    padding: 30px;
  ...
  .main-image-slider {
    flex: 1;
    min-height: 600px; /* Even bigger mobile image height */
  }
  ...
  .thumb-item {
    ...
    &:hover,
    &.swiper-slide-active {
      transform: translateY(-2px) scale(1.02); /* Reduced to prevent mobile cropping */
      overflow: hidden;
    }
  }
